...
#ifndef FONT5X7NBOX_H
#define FONT5X7NBOX_H

#define FONT5X7NBOX_WIDTH 5
#define FONT5X7NBOX_HEIGHT 7

static uint8_t Font5x7Nbox[] PROGMEM = {
    0x01, 0x92, // size
    0x05, // width
    0x07, // height
    0x30, // first char
